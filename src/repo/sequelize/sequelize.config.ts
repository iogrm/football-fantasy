...
import Follow, { initFollowDB } from "./model/follow.model";
import Like, { initLikeDB } from "./model/like.model";
import Player, { initPlayerDB } from "./model/player.model";
import PlayerStatus, { initPlayerStatusDB } from "./model/player-stats.model";
import Recrutment, { initRecrutmentDB } from "./model/recrutment.model";
import Replacement, { initReplacementDB } from "./model/replacement.model";
import Team, { initTeamDB } from "./model/team.model";
import User, { initUserDB } from "./model/user.model";
import Week, { initWeekDB } from "./model/week.model";
