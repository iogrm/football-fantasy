...
import Follow, { initFollowDB } from "../follow/follow.model";
import Like, { initLikeDB } from "../vitrine/like.model";
import Player, { initPlayerDB } from "../player/player.model";
...
import Team, { initTeamDB } from "../team/team.model";
import User, { initUserDB } from "../user/user.model";
import Week, { initWeekDB } from "../week/week.model";
